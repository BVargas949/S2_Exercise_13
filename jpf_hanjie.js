...
function init() {
      ...
      //add event listener to the chow solution button
...
function setupPuzzle() {
      ...
      var filled = document.querySelectorAll("table#hanjiGrid td.empty");
...
function setBackground(e) {
      ...
      if (e.shiftKey) {
            cellBackground = "rgb(223, 207, 29)";
            cursorType = "url(jpf_eraser.png), cell";
      } else if (e.altKey) {
            cellBackground = "rgb(255, 2555, 255)";
